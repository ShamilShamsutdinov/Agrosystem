...
define("SND_TO", "89140004338@ya.ru, franch5.leads@gmail.com, leads@conversionpro.agency"); // allowble comma-sepparated values
define("SND_NAME", "Agrosystem");
define("NAME_FRANCH", "Агросистема");
define("SMTP", false); // see settings in Helper.php before you change this const
define("SND_TO_BITRIX", false); // Разрешить отправку лидов в Битрикс. true - отправляем, false - запрещаем // тут нужно false
